...
!!! info
    ...
    **Source Code Repository:** [https://github.com/mvaldron-rhdh/chatbot-test-app-48](https://github.com/mvaldron-rhdh/chatbot-test-app-48)

    **GitOps Repository:** [https://github.com/mvaldron-rhdh/chatbot-test-app-48-gitops](https://github.com/mvaldron-rhdh/chatbot-test-app-48-gitops)

# **Usage**

To access the chatbot-test-app-48 application that was deployed using the Software Template, complete the following instructions:
